...
var LoginOptionPageModule = /** @class */ (function () {
    function LoginOptionPageModule() {
    }
...
var LoginOptionPage = /** @class */ (function () {
    function LoginOptionPage(loginauth, router) {
    ...
    LoginOptionPage.prototype.ngOnInit = function () {
        this.SelectOption();
    };
    LoginOptionPage.prototype.SelectOption = function () {
        try {
    ...
    LoginOptionPage.prototype.onclickLoginTypewms = function (type) {
    ...
    LoginOptionPage.prototype.onclickLoginTypevet = function (type) {
        this.loginauth.logintype = type;
        this.router.navigate(['use-vetcoins']);
    };
    LoginOptionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=login-option-login-option-module-es5.js.map