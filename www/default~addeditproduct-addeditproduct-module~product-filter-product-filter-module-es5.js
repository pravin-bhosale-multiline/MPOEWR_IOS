...
var ProductFilterPage = /** @class */ (function () {
    function ProductFilterPage(modalCtrl, productFilterService, commonFunction, alertController, navParams) {
    ...
    ProductFilterPage.prototype.ngOnInit = function () {
    ...
    ProductFilterPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.productFilterService.getSubFilterList(this.business_partner).toPromise()];
                    case 1:
                        _a.sideMenuList = _b.sent();
                        ...
                        if (!!this.tempSelectedFilter) {
                            ...
                            this.tempSelectedFilter.forEach(function (element, index) {
                                _this.sideMenuList.forEach(function (side_element, sub_menu_main_index) {
                                    if (element.catid == side_element.catid) {
                                        element.catvalues.forEach(function (cat_ele) {
                                            side_element.catvalues.forEach(function (cat_sub_element, cat_index) {
    ...
    ProductFilterPage.prototype.clearFilter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1, error_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductFilterPage.prototype.applyFilter = function () {
        try {
    ...
    ProductFilterPage.prototype.menuItemClick = function (selectedItem, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
    ...
    ProductFilterPage.prototype.chkSubSelectFilter = function (subData, checked, event) {
        var _this = this;
        try {
            ...
            if (!!this.selectedFilter) {
                if (checked) {
                    ...
                    var data = this.selectedFilter.find(function (ob) { return ob.catid === _this.selectedMainItem.catid; });
                    if (data === null || data === undefined) {
                        ...
                        var index = this.selectedFilter.findIndex(function (ob) { return ob.catid === _this.selectedMainItem.catid; });
                    ...
                    var main_index_1 = this.selectedFilter.findIndex(function (ob) { return ob.catid === _this.selectedMainItem.catid; });
                    this.selectedFilter[main_index_1].catvalues.forEach(function (value, index) {
                        if (value.subcatid == subData.subcatid) {
                            //console.log("selected",this.selectedFilter[index]);
                            if (_this.selectedFilter[main_index_1].catvalues.length == 1) {
                                _this.selectedFilter.splice(main_index_1, 1);
                            }
                            else {
                                _this.selectedFilter[main_index_1].catvalues.splice(index, 1);
                            }
                        }
                    });
                }
                ...
                var temp = [{ catid: this.selectedMainItem.catid, catname: this.selectedMainItem.catname, catvalues: [{ "subcatid": subData.subcatid, "subcatname": subData.subcatname, columnname: subData.columnname, "checked": true }] }];
    ...
    ProductFilterPage.prototype.dismiss = function () {
        // using the injected ModalController this page
        // can "dismiss" itself and optionally pass back data
        this.modalCtrl.dismiss(this.selectedFilter);
    };
    ProductFilterPage.prototype.onFilterSearch = function () {
        try {
        }
        catch (error) {
            console.log(this.TAG, error);
    ...
    ProductFilterPage.ctorParameters = function () { return [
...
var ProductFilterService = /** @class */ (function () {
    function ProductFilterService(genericHttpClientService, loginService, commonFunction, httpClient) {
    ...
    ProductFilterService.prototype.getSubFilterList = function (business_partner) {
        try {
            //return this.httpClient.get('assets/data/price.json');
            var getFilterURL = _common_Constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].DOMAIN_URL + '/openbravo' + '/ws/in.mbs.webservice.DynamicFilterAsPerActivity?' +
    ...
    ProductFilterService.ctorParameters = function () { return [
...
//# sourceMappingURL=default~addeditproduct-addeditproduct-module~product-filter-product-filter-module-es5.js.map