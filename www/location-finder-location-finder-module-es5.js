...
var LocationFinderPageModule = /** @class */ (function () {
    function LocationFinderPageModule() {
    }
    ...
    return LocationFinderPageModule;
}());
...
var LocationFinderPage = /** @class */ (function () {
    function LocationFinderPage(fb, neworderservice, geolocation, platform, nativeGeocoder, zone, loginauth, locationfinderservice, commonfun, msg, locationAccuracy) {
        this.fb = fb;
    ...
    LocationFinderPage.prototype.ngOnInit = function () {
        var _this = this;
        var mapOptions = {
            camera: {
                target: {
    ...
    LocationFinderPage.prototype.ionViewWillEnter = function () {
    };
    /**
     * @kind function
     ...
     */
    LocationFinderPage.prototype.saveForm = function (val) {
        var _this = this;
        var methodTAG = 'latlongSubmit';
        try {
            ...
            this.locationfinderservice.LatLongUpdate(this.selectedAddressDropDown.addressid, this.txtLatitude, this.txtLongitude).subscribe(function (data) {
                var response = data;
                if (response.status == "Success") {
                    _this.commonfun.presentAlert("Message", "Success", response.msg);
                    _this.Resetpage();
                }
                else {
                    _this.commonfun.presentAlert("Message", response.status, response.msg);
                }
            }, function (error) {
    ...
    LocationFinderPage.prototype.onClose = function (event) {
     ...
     * @author Pravin Bhosale
     */
    LocationFinderPage.prototype.captureLatLong = function () {
        var _this = this;
        var methodTAG = 'captureLatLong';
        try {
            ...
            if (this.msg.isplatformweb == false) {
                this.locationAccuracy.request(this.locationAccuracy.REQUEST_PRIORITY_HIGH_ACCURACY).then(function () {
                    _this.geolocation.getCurrentPosition().then(function (resp) {
                        _this.txtLatitude = resp.coords.latitude;
                        _this.txtLongitude = resp.coords.longitude;
    ...
    LocationFinderPage.prototype.onAddChange = function () {
        try {
    ...
    LocationFinderPage.prototype.convertAddressToLatLong = function () {
        var methodTAG = 'convertAddressToLatLong';
        try {
     ...
     * @author Pravin Bhosale.
     */
    LocationFinderPage.prototype.onCustDropDownSearch = function (event) {
        var methodTAG = 'onCustDropDownSearch';
        try {
    ...
    */
    ...
    LocationFinderPage.prototype.onCustDropDownChange = function (event) {
        var methodTAG = 'onCustDropDownChange';
        try {
     ...
     * @author Pravin Bhosale.
     */
    LocationFinderPage.prototype.bindCustomerFromApi = function (strsearch) {
        var _this = this;
        var methodTAG = 'bindCustomerFromApi';
        try {
            if (strsearch != "") {
                this.locationfinderservice.getUserWiseCustomerForLatLong(strsearch).subscribe(function (data) {
                    var response = data;
    ...
    LocationFinderPage.prototype.checkcust = function () {
        var _this = this;
        try {
            this.locationfinderservice.getUserWiseCustomerForLatLong("").subscribe(function (data) {
                var response = data;
                _this.leastBusinessPartnerlist = response;
                if (_this.leastBusinessPartnerlist) {
                    if (_this.leastBusinessPartnerlist.length == 1) {
                        _this.BusinessPartnerlist = _this.leastBusinessPartnerlist;
                        _this.latLongForm.controls["selectedBusinessPartner"].setValue(_this.BusinessPartnerlist[0]);
                        //this.onCustDropDownChange(this.BusinessPartnerlist[0]);
                        _this.getCustomerAddress(_this.BusinessPartnerlist[0]);
                    }
                    else if (_this.leastBusinessPartnerlist.length > _this.loginauth.minlistcount) {
                        _this.BusinessPartnerlist = null;
                        _this.latLongForm.controls["selectedBusinessPartner"].setValue(null);
                    }
                    else {
                        _this.BusinessPartnerlist = _this.leastBusinessPartnerlist;
                        _this.latLongForm.controls["selectedBusinessPartner"].setValue(null);
    ...
    * @author Pravin Bhosale.
    */
    LocationFinderPage.prototype.getCustomerAddress = function (selectedBusinessPartner) {
        var methodTAG = 'getCustomerAddress';
        try {
            var jsondata = selectedBusinessPartner.AddressList;
   ...
   */
    LocationFinderPage.prototype.reverseGeocode = function (lat, lng) {
        var methodTAG = 'reverseGeocode';
        try {
     ...
     * @see https://ionicframework.com/docs/native/native-geocoder.
     */
    LocationFinderPage.prototype.forwardGeocode = function (address) {
        var _this = this;
        var methodTAG = 'forwardGeocode';
        try {
            //    if (this.platform.is('cordova')) {
            if (this.msg.isplatformweb == false) {
                var options = {
                ...
                this.nativeGeocoder.forwardGeocode(address, options)
                    ...
                    _this.zone.run(function () {
                        _this.txtLatitude = result[0].latitude;
                        _this.txtLongitude = result[0].longitude;
                    });
                })
                    .catch(function (error) {
    ...
    LocationFinderPage.prototype.Resetpage = function () {
        try {
    ...
    LocationFinderPage.ctorParameters = function () { return [
...
var LocationFinderService = /** @class */ (function () {
    function LocationFinderService(http, loginauth, genericHTTP) {
        this.http = http;
        this.loginauth = loginauth;
        this.genericHTTP = genericHTTP;
    }
    LocationFinderService.prototype.getcustmerbillingaddress = function (leadid) {
    ...
    LocationFinderService.prototype.getUserWiseCustomerForLatLong = function (strsearch) {
    ...
    LocationFinderService.prototype.LatLongUpdate = function (addid, lat, long) {
        return this.genericHTTP.get(this.loginauth.commonurl + 'ws/in.mbs.webservice.WMobileLatLongUpdate?'
            + '&addid=' + addid
            + '&lat=' + long
            + '&long=' + lat);
    };
    LocationFinderService.ctorParameters = function () { return [
...
//# sourceMappingURL=location-finder-location-finder-module-es5.js.map