...
var AddEditServiceProductPageModule = /** @class */ (function () {
    function AddEditServiceProductPageModule() {
    }
    ...
    return AddEditServiceProductPageModule;
}());
...
var AddEditServiceProductPage = /** @class */ (function () {
    function AddEditServiceProductPage(formBuilder, router, route, commonFunction, customerQuotationService, loginService) {
    ...
    AddEditServiceProductPage.prototype.ngOnInit = function () {
    ...
    AddEditServiceProductPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        try {
            //  console.log(this.TAG,"ionViewWillEnter"); 
            this.route.queryParams.subscribe(function (data) {
                if (!!data["quotation_data"] && data["quotation_data"].length > 0) {
                    _this.selectedQuotationData = JSON.parse(data["quotation_data"]);
                    //  console.log(this.TAG,JSON.parse(data["quotation_data"]));
                    _this.selectedSerialNumberProductListQuotation = JSON.parse(data["selectedSerialNumberProductList"]);
                    _this.tempCartProduct = _this.selectedSerialNumberProductListQuotation;
                    if (!!_this.selectedQuotationData) {
                        if (_this.selectedQuotationData.service_product_id.id) {
                            _this.customerQuotationService.getSerialNoProductList(_this.selectedQuotationData.service_product_id.id, "").subscribe(function (tempSerialNumberLess10) {
                                //  console.log(this.TAG,tempSerialNumberLess10);
                                if (!!tempSerialNumberLess10) {
                                    // this.serialNoList = tempSerialNumberLess10;
                                    if (tempSerialNumberLess10.length > _this.loginService.minlistcount) {
                                        _this.tempSerialNumberLess10 = [];
                                    }
                                    else {
                                        setTimeout(function () {
                                            _this.tempSerialNumberLess10 = tempSerialNumberLess10;
                                            if (_this.tempSerialNumberLess10.length == 1) {
                                                _this.addEditServiceProductForm.controls["serialNoCtrl"].setValue(_this.tempSerialNumberLess10[0]);
                                                _this.selectedSerialNo = _this.serialNoList[0];
                                            }
                                        }, 100);
                                    }
                                }
                    ...
                    if (!!_this.tempCartProduct) {
                        _this.btnSaveDisabled = true;
                    }
    ...
    AddEditServiceProductPage.prototype.onSerialNoClose = function (event) {
        try {
    ...
    AddEditServiceProductPage.prototype.onSerialNoChange = function (event) {
        try {
    ...
    AddEditServiceProductPage.prototype.onSerialNoSearch = function (event) {
        try {
    ...
    AddEditServiceProductPage.prototype.bindSerialNoProduct = function (strsearch) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
                    if (strsearch != "") {
                        this.customerQuotationService.getSerialNoProductList(this.selectedQuotationData.service_product_id.id, strsearch).subscribe(function (response) {
    ...
    AddEditServiceProductPage.prototype.removeProduct = function (deletedSerial) {
        try {
            var result = this.tempCartProduct.filter(function (item) { return item.m_attributesetinstance_id != deletedSerial.m_attributesetinstance_id; });
    ...
    AddEditServiceProductPage.prototype.onSaveCart = function () {
        try {
    ...
    AddEditServiceProductPage.prototype.addToCart = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var result, productDetailResponse, tempBuild, error_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!!!this.tempCartProduct) return [3 /*break*/, 3];
                        result = this.tempCartProduct.filter(function (item) { return item.m_attributesetinstance_id == _this.selectedSerialNo.m_attributesetinstance_id; });
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.customerQuotationService.getSerialNoProductDetail(this.selectedQuotationData.selectedBusinessPartnerKey.id, this.selectedQuotationData.service_product_id.id, this.selectedQuotationData.bp_shiping_add_id.id, this.selectedQuotationData.bp_billing_add_id.id).toPromise()];
                    case 2:
                        productDetailResponse = _a.sent();
                        tempBuild = {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        this.commonFunction.presentAlert("Add Product", error_1.status, error_1.error);
                        return [3 /*break*/, 5];
    ...
    AddEditServiceProductPage.ctorParameters = function () { return [
    ...
    return AddEditServiceProductPage;
}());
...
//# sourceMappingURL=quotation-add-edit-service-product-add-edit-service-product-module-es5.js.map