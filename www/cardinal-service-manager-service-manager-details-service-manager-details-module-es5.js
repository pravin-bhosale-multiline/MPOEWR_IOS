...
var ServiceManagerDetailsPageModule = /** @class */ (function () {
    function ServiceManagerDetailsPageModule() {
    }
    ...
    return ServiceManagerDetailsPageModule;
}());
...
var ServiceManagerDetailsPage = /** @class */ (function () {
    function ServiceManagerDetailsPage(route, router, formBuilder, validator, serviceManagerService, commonFunction, newcustomerservice, customerService, alertCtrl) {
        this.route = route;
        this.router = router;
    ...
    ServiceManagerDetailsPage.prototype.ngOnInit = function () {
                    ...
                    case 0:
                        ...
                        this.route.queryParams.subscribe(function (params) {
                            if (params && params.special) {
                                _this.existingComplaint = JSON.parse(params.special);
                        ...
                        _a = this;
                        return [4 /*yield*/, this.serviceManagerService.getDealerList()];
                    case 1: return [4 /*yield*/, (_d.sent()).toPromise()];
                    case 2:
                        _a.dealerList = _d.sent();
                        _b = this;
                        return [4 /*yield*/, this.serviceManagerService.getSalesRepresentativeList(this.existingComplaint.olddealerid)];
                    case 3: return [4 /*yield*/, (_d.sent()).toPromise()];
                    case 4:
                        _b.salesRepresentativeList = _d.sent();
                        ...
                        // }
                        _c = this;
                        return [4 /*yield*/, this.serviceManagerService.getVenderList()];
                    case 5: return [4 /*yield*/, (_d.sent()).toPromise()];
                    case 6:
                        // if(!!this.dealerList && Object.keys(this.dealerList).length == 0){
                        //   this.salesRepresentativeList = await (await this.serviceManagerService.getSalesRepresentativeList("")).toPromise();
                        // }
                        _c.venderList = _d.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    ServiceManagerDetailsPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var test, _a, i, _b, i, _c, i;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        test = this.existingComplaint.area;
                        this.areaList = test;
                        this.areaType = test[0];
                        this.docType = this.existingComplaint.doctype[0];
                        _a = this;
                        return [4 /*yield*/, this.serviceManagerService.getDesignationOfComplainerList()];
                    case 1: return [4 /*yield*/, (_d.sent()).toPromise()];
                    case 2:
                        _a.designationOfComplainerList = _d.sent();
                        for (i = 0; i < this.designationOfComplainerList.length; i++) {
    ...
    ServiceManagerDetailsPage.prototype.bindData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, i, dealer_id, _b, _loop_1, this_1, i, error_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!!!this.existingComplaint.newdealername) return [3 /*break*/, 3];
                        _a = this;
                        return [4 /*yield*/, this.serviceManagerService.getDealerList()];
                    case 1: return [4 /*yield*/, (_c.sent()).toPromise()];
                    case 2:
                        _a.dealerList = _c.sent();
                        for (i = 0; i < this.dealerList.length; i++) {
                        ...
                        _c.label = 3;
                    case 3:
                        if (!!!this.existingComplaint.salesrepid) return [3 /*break*/, 6];
                        dealer_id = "";
                        ...
                        _b = this;
                        return [4 /*yield*/, this.serviceManagerService.getSalesRepresentativeList(dealer_id)];
                    case 4: return [4 /*yield*/, (_c.sent()).toPromise()];
                    case 5:
                        _b.salesRepresentativeList = _c.sent();
                        _loop_1 = function (i) {
                            if (this_1.salesRepresentativeList[i].id == this_1.existingComplaint.salesrepid) {
                                setTimeout(function () {
                                    _this.salesRepresentativeSelected = _this.salesRepresentativeList[i];
                                }, 300);
                            }
                        };
                        this_1 = this;
                        for (i = 0; i < this.salesRepresentativeList.length; i++) {
                            _loop_1(i);
                        }
                        _c.label = 6;
    ...
    ServiceManagerDetailsPage.prototype.refreshPage = function () {
        try {
        }
        catch (error) {
    ...
    ServiceManagerDetailsPage.prototype.matDetailSettper = function (form) {
        try {
    ...
    ServiceManagerDetailsPage.prototype.matSettperProductCompliant = function (event) {
        try {
        }
        catch (error) {
            //  console.error(this.TAG,error);
    ...
    ServiceManagerDetailsPage.prototype.matSettperConsumables = function (event) {
        try {
        }
        catch (error) {
            //   console.error(this.TAG,error);
    ...
    ServiceManagerDetailsPage.prototype.matSettperSKUDetails = function (event) {
        try {
        }
        catch (error) {
            //  console.error(this.TAG,error);
    ...
    ServiceManagerDetailsPage.prototype.matSettperEquiment = function (event) {
        try {
    ...
    ServiceManagerDetailsPage.prototype.approveComplaintCheckbox = function (value) {
        try {
    ...
    ServiceManagerDetailsPage.prototype.disFormControl = function (value) {
        try {
            if (value == "dis") {
    ...
    ServiceManagerDetailsPage.prototype.designationOfComplainerChange = function (data) {
        try {
        }
        catch (error) {
            console.error(this.TAG, error);
    ...
    ServiceManagerDetailsPage.prototype.docTypeSelectedChange = function (data) {
        try {
        }
        catch (error) {
            console.error(this.TAG, error);
    ...
    ServiceManagerDetailsPage.prototype.onAreaSelectedChange = function () {
        try {
    ...
    ServiceManagerDetailsPage.prototype.onChangePinCode = function (id) {
        var _this = this;
        if (id === void 0) { id = ''; }
        try {
            this.newcustomerservice.getPincode(this.customerDetailFormGroup.controls["pinCodeCtrl"].value).subscribe(function (data) {
                ...
                if (_this.pinCodeList.length > 0) {
                    ...
                    _this.newcustomerservice.getarea(_this.pinCodeList[0].id).subscribe(function (data) {
                        ...
                        _this.existingComplaint.city[0].id = response.data[0].cttv;
                        ...
                        _this.areaList = addressArray;
                        _this.existingComplaint.area = _this.areaList;
                        _this.state = _this.pinCodeList[0].region$_identifier;
                        _this.existingComplaint.state[0].id = _this.pinCodeList[0].region;
                        ...
                        if (id != '' || id == undefined) {
                            ...
                            setTimeout(function () {
                                _this.customerDetailFormGroup.controls["areaCtrl"].setValue(_this.selectedArea);
                            }, 1500);
                        }
                    });
                }
    ...
    ServiceManagerDetailsPage.prototype.newDealerNameChange = function (dealer) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, error_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.serviceManagerService.getSalesRepresentativeList(dealer.id)];
                    case 1: return [4 /*yield*/, (_b.sent()).toPromise()];
                    case 2:
                        // console.log(this.TAG,"PRavin DEA selected",dealer);
                        _a.salesRepresentativeList = _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _b.sent();
    ...
    ServiceManagerDetailsPage.prototype.salesRepresentativeChange = function (value) {
        try {
        }
        catch (error) {
            // console.log(this.TAG,error);
    ...
    ServiceManagerDetailsPage.prototype.presentAlert = function (Header, SubHeader, Message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [{
                                    text: "OK",
                                    handler: function (ok) {
                                        _this.router.navigateByUrl('/service-manager');
                                    }
                                }]
                        })];
                    case 1:
    ...
    ServiceManagerDetailsPage.prototype.errorCodeSelectedSelectedChange = function (data) {
        try {
        }
        catch (error) {
            // console.log(this.TAG,error);
    ...
    ServiceManagerDetailsPage.prototype.onCheckInstallationBase = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var serialNo, _a, i, _b, error_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        serialNo = this.equimentFormGroup.get('serialNoCtrl').value ? this.equimentFormGroup.get('serialNoCtrl').value : '';
                        this.existingComplaint.serialno = serialNo;
                        _a = this;
                        return [4 /*yield*/, this.customerService.checkSerialNumber(serialNo, "2020-12-31")];
                    case 1: return [4 /*yield*/, (_c.sent()).toPromise()];
                    case 2:
                        _a.serialNoCheckResponse = _c.sent();
                        console.log(this.TAG, "Installation Base Data", this.serialNoCheckResponse);
                        if (!(Object.keys(this.serialNoCheckResponse).length != 0)) return [3 /*break*/, 8];
                        ...
                        if (!!!this.serialNoCheckResponse.dealername) return [3 /*break*/, 6];
                        ...
                        if (!!!this.serialNoCheckResponse.dealerid) return [3 /*break*/, 5];
                        _b = this;
                        return [4 /*yield*/, this.serviceManagerService.getSalesRepresentativeList(this.serialNoCheckResponse.dealerid)];
                    case 3: return [4 /*yield*/, (_c.sent()).toPromise()];
                    case 4:
                        _b.salesRepresentativeList = _c.sent();
                        _c.label = 5;
    ...
    ServiceManagerDetailsPage.prototype.submit = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var date, approveComplain, area, saveComplainResponse, error_4;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        date = this.equimentFormGroup.get('installationDateCtrl').value ? this.equimentFormGroup.get('installationDateCtrl').value : '';
                        if (!(date === '' || date === null || date === undefined)) return [3 /*break*/, 1];
                    ...
                    case 1:
                        this.commonFunction.loadingPresent();
                        approveComplain = new src_assets_model_complain__WEBPACK_IMPORTED_MODULE_9__["Complain"]();
                        ...
                        area = this.customerDetailFormGroup.get('areaCtrl').value ? this.customerDetailFormGroup.get('areaCtrl').value : '';
                        ...
                        return [4 /*yield*/, this.customerService.saveComplain(approveComplain).toPromise()];
                    case 2:
    ...
    ServiceManagerDetailsPage.ctorParameters = function () { return [
    ...
    return ServiceManagerDetailsPage;
}());
...
//# sourceMappingURL=cardinal-service-manager-service-manager-details-service-manager-details-module-es5.js.map