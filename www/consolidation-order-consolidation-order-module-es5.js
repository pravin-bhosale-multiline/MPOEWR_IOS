...
var ConsolidationOrderPageModule = /** @class */ (function () {
    function ConsolidationOrderPageModule() {
    }
    ...
    return ConsolidationOrderPageModule;
}());
...
var ConsolidationOrderPage = /** @class */ (function () {
    function ConsolidationOrderPage(consolidationOrderService, formBuilder, validator, commonFunction, loginauth, http, alertCtrl, router) {
    ...
    ConsolidationOrderPage.prototype.ngOnInit = function () {
    ...
    ConsolidationOrderPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var tempResponse, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.consolidationOrderService.getPrimaryCustomer().toPromise()];
                    case 1:
    ...
    ConsolidationOrderPage.prototype.bindCustomerBillingAddress = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.consolidationOrderService.getPrimaryCustomerBillingAddress(this.selectedPrimaryBusinessPartner.id).toPromise()];
                    case 1:
                        ...
                        setTimeout(function () {
                            if (_this.custShippingAddressList.length == 1) {
                                _this.consolidationOrderForm.controls["selectedBPaddressShippingCtrl"].setValue(_this.custShippingAddressList[0]);
                            }
                            if (_this.custBillingAddressList.length == 1) {
                                _this.consolidationOrderForm.controls["selectedBPAddressBillingCtrl"].setValue(_this.custBillingAddressList[0]);
                            }
                        }, 100);
                        return [3 /*break*/, 3];
                    case 2:
    ...
    ConsolidationOrderPage.prototype.refreshPage = function () {
        try {
    ...
    ConsolidationOrderPage.prototype.onCustomerChange = function (event) {
        try {
    ...
    ConsolidationOrderPage.prototype.onCustomerClose = function (event) {
        try {
    ...
    ConsolidationOrderPage.prototype.onCustomerSearchChange = function (event) {
        try {
    ...
    ConsolidationOrderPage.prototype.bindPrimaryCustomerFromApi = function (strsearch) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var cust_response, error_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!(strsearch != "")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.consolidationOrderService.getPrimaryCustomer(strsearch).toPromise()];
                    case 1:
    ...
    ConsolidationOrderPage.prototype.toggleSecondaryBusinessPartner = function (event, item) {
        try {
        }
        catch (error) {
            //  console.log(this.TAG,error);
    ...
    ConsolidationOrderPage.prototype.presentAlert = function (Header, SubHeader, Message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [{
                                    ...
                                    handler: function (ok) {
                                        ...
                                        _this.page.totalElements = 0;
                                        _this.consolidationOrderForm.reset();
                                        _this.rows = [];
    ...
    ConsolidationOrderPage.prototype.onConsolidateOrder = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var Shipping, Billing, consolidateOrderResponse, error_4;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        this.commonFunction.loadingPresent();
                        Shipping = this.consolidationOrderForm.get('selectedBPaddressShippingCtrl').value.id;
                        Billing = this.consolidationOrderForm.get('selectedBPAddressBillingCtrl').value.id;
                        return [4 /*yield*/, this.consolidationOrderService.consolidateOrderService(this.selected, this.selectedPrimaryBusinessPartner, Shipping, Billing).toPromise()];
                    case 1:
                        consolidateOrderResponse = _a.sent();
                    ...
                    case 4:
                        error_4 = _a.sent();
                        this.commonFunction.loadingDismiss();
                        this.commonFunction.presentAlert("Consolidation Order", "Error", error_4.error);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    ConsolidationOrderPage.prototype.onCloseOrder = function (formData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var Shipping, Billing, consolidateOrderResponse, error_5;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        Shipping = this.consolidationOrderForm.get('selectedBPaddressShippingCtrl').value.id;
                        Billing = this.consolidationOrderForm.get('selectedBPAddressBillingCtrl').value.id;
                        return [4 /*yield*/, this.consolidationOrderService.consolidateOrderCloseService(this.selected, this.selectedPrimaryBusinessPartner, Shipping, Billing).toPromise()];
                    case 1:
                        consolidateOrderResponse = _a.sent();
                        ;
                        //  console.log(this.TAG,"on Close Order Status",consolidateOrderResponse);
                    ...
                    case 4:
                        error_5 = _a.sent();
                        this.commonFunction.loadingDismiss();
                        this.commonFunction.presentAlert("Consolidation Order", "Error", error_5.error);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    ConsolidationOrderPage.prototype.getSecondaryCustomer = function (pageInfo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var offset, _a, error_6;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        offset = 0;
                        if (!(this.higgestPageOffset < pageInfo.offset)) return [3 /*break*/, 2];
                        ...
                        _a = this;
                        return [4 /*yield*/, this.consolidationOrderService.getSecondaryCustomerFromApi(this.selectedPrimaryBusinessPartner.id, offset).toPromise()];
                    case 1:
                        _a.secondaryBusinessPartnerList = _b.sent();
                        // console.log(this.TAG,"Secondary Customer",this.secondaryBusinessPartnerList);
                        if (!!this.rows) {
                            this.higgestPageOffset = pageInfo.offset;
                            this.rows = this.rows.concat(this.secondaryBusinessPartnerList.filter(function (x) { return _this.rows.every(function (y) { return y !== x; }); }));
                        }
                        else {
                            this.higgestPageOffset = pageInfo.offset;
    ...
    ConsolidationOrderPage.prototype.onSelect = function (_a) {
    ...
    ConsolidationOrderPage.prototype.onActivate = function (event) {
        //  console.log('Activate Event', event);
    };
    ConsolidationOrderPage.ctorParameters = function () { return [
...
var companyData = _assets_data_company_json__WEBPACK_IMPORTED_MODULE_10__;
var ConsolidationOrderService = /** @class */ (function () {
    function ConsolidationOrderService(genericHttpClientService, loginService, commonFunction, platform, http) {
    ...
    ConsolidationOrderService.prototype.getPrimaryCustomer = function (strsearch) {
        try {
            if (!!strsearch) {
    ...
    ConsolidationOrderService.prototype.getPrimaryCustomerBillingAddress = function (businessPartner_id) {
        try {
    ...
    ConsolidationOrderService.prototype.getSecondaryCustomerFromApi = function (bp_id, offset) {
        try {
            //  console.log(this.TAG,offset);
            var getCustomerURL = this.loginService.commonurl + 'ws/in.mbs.webservice.SebiaSecondaryCustList?'
                + this.loginService.parameter
                + '&user_id=' + this.loginService.userid
                + '&bp_id=' + bp_id
                + '&offset=' + offset
                + '&activity_id=' + this.loginService.selectedactivity.id;
            var dummyURL = "https://p2test.pispl.in/openbravo/ws/in.mbs.webservice.SebiaSecondaryCustList?user=hardik.pandya&password=pass&user_id=FFF20200727061334922CD0B9DE67B63&bp_id=FFF2020030902464717516D985A526FB&offset=20&activity_id=FFF202012061211195489D3E4DD35FC1";
    ...
    ConsolidationOrderService.prototype.getDummy = function () {
        try {
     ...
     */
    ConsolidationOrderService.prototype.getResults = function (page) {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(companyData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (d) { return _this.getPagedData(page); }));
    };
    /**
     ...
     */
    ConsolidationOrderService.prototype.getPagedData = function (page) {
        var pagedData = new src_assets_model_PagedData__WEBPACK_IMPORTED_MODULE_6__["PagedData"]();
        ...
        for (var i = start; i < end; i++) {
            var jsonObj = companyData[i];
            var employee = new src_assets_model_CorporateEmployee__WEBPACK_IMPORTED_MODULE_5__["CorporateEmployee"](jsonObj.name, jsonObj.gender, jsonObj.company, jsonObj.age);
            pagedData.data.push(employee);
        }
        pagedData.page = page;
        return pagedData;
    };
    ConsolidationOrderService.prototype.consolidateOrderService = function (orderList, selectedBusinessPartner, Shipping, Billing) {
        try {
            ...
            var mbso_copord_id_1 = [];
            orderList.forEach(function (element) {
                mbso_copord_id_1.push(element.mbso_copord_id);
            });
            var dataClose = {
                ...
                "billloc_id": Billing,
                "user_id": this.loginService.userid,
                "mbso_copord_id": mbso_copord_id_1
            };
            //  console.log(this.TAG,"Consolidate Order Service Post FINAL",dataClose);
            var consolidate_order_url = _common_Constants__WEBPACK_IMPORTED_MODULE_12__["Constants"].DOMAIN_URL + '/openbravo' + '/ws/in.mbs.webservice.SebiaConsolidatedOrder?';
    ...
    ConsolidationOrderService.prototype.consolidateOrderCloseService = function (orderList, selectedBusinessPartner, Shipping, Billing) {
        try {
            var login = this.loginService.user;
            var password = this.loginService.pass;
            var auth = btoa(login + ":" + password);
            ...
            var mbso_copord_id_2 = [];
            orderList.forEach(function (element) {
                mbso_copord_id_2.push(element.mbso_copord_id);
            });
            var dataClose = {
                ...
                "billloc_id": Billing,
                "user_id": this.loginService.userid,
                "mbso_copord_id": mbso_copord_id_2
            };
            //  console.log(this.TAG,"Consolidate Order Close Service Post FINAL",dataClose);
            var consolidate_order_close_url = _common_Constants__WEBPACK_IMPORTED_MODULE_12__["Constants"].DOMAIN_URL + '/openbravo' + '/ws/in.mbs.webservice.SebiaConsolidatedOrder?';
    ...
    ConsolidationOrderService.ctorParameters = function () { return [
    ...
    return ConsolidationOrderService;
}());
...
var CorporateEmployee = /** @class */ (function () {
    function CorporateEmployee(name, gender, company, age) {
        this.name = name;
        this.gender = gender;
        this.company = company;
        this.age = age;
    }
    CorporateEmployee.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: Number }
...
//# sourceMappingURL=consolidation-order-consolidation-order-module-es5.js.map