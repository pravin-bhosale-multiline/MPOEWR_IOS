...
var UploadPage = /** @class */ (function () {
    function UploadPage(formBuilder, commonFunction, uploadService, fileChooser, msg, filePlugin, transfer, loginService, fileOpener, androidPermissions, iab, filePath, fileMeta, platform, filePicker) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.uploadService.getMasterCategoryList().toPromise()];
                    case 1:
                        _a.masterCategoryList = _b.sent();
    ...
    UploadPage.prototype.onMasterCategoryChange = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, error_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!!!this.selectedMasterCategory.id) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.uploadService.getMasterSubCategoryList(this.selectedMasterCategory.id).toPromise()];
                    case 1:
                        _a.masterSubCategoryList = _b.sent();
    ...
    UploadPage.prototype.onMasterCategoryClose = function (event) {
        try {
    ...
    UploadPage.prototype.onMasterCategorySearchChange = function (event) {
        try {
        }
        catch (error) {
            console.log(this.TAG, error);
    ...
    UploadPage.prototype.onMasterSubCategoryChange = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, error_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!!!this.selectedMasterCategory.id) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.uploadService.getMasterNameList(this.selectedMasterCategory.id, this.selectedMasterSubCategory.id).toPromise()];
                    case 1:
                        _a.masterNameList = _b.sent();
    ...
    UploadPage.prototype.onMasterSubCategoryClose = function (event) {
        try {
            event.component._searchText = "";
        }
        catch (error) {
    ...
    UploadPage.prototype.onMasterSubCategorySearchChange = function (event) {
        try {
        }
        catch (error) {
            console.log(this.TAG, error);
    ...
    // Master Name Start
    UploadPage.prototype.onMasterNameChange = function () {
        try {
        }
        catch (error) {
            console.log(this.TAG, error);
    ...
    UploadPage.prototype.onMasterNameClose = function (event) {
        try {
            event.component._searchText = "";
        }
        catch (error) {
    ...
    UploadPage.prototype.onMasterNameSearchChange = function (event) {
        try {
        }
        catch (error) {
            console.log(this.TAG, error);
    ...
    // Organization Start
    UploadPage.prototype.onOrganizationChange = function (selectedOrganization) {
        try {
    ...
    UploadPage.prototype.onOrganizationClose = function (event) {
        try {
            event.component._searchText = "";
        }
        catch (error) {
    ...
    UploadPage.prototype.onOrganizationSearchChange = function (event) {
        try {
    ...
    UploadPage.prototype.bindOrganizationFromApi = function (strsearch) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var cust_response, error_4;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.uploadService.getOrganizationList(strsearch).toPromise()];
                    case 1:
                        cust_response = _a.sent();
                        console.log(this.TAG, cust_response);
                        this.organizationList = cust_response;
                        setTimeout(function () {
                            if (_this.organizationList.length == 1) {
                                _this.uploadForm.controls["interfaceOrganizationCtrl"].setValue(_this.organizationList[0]);
                            }
                        }, 100);
                        return [3 /*break*/, 3];
                    case 2:
                        error_4 = _a.sent();
                        console.log(this.TAG, error_4);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UploadPage.prototype.uploadFileWeb = function (str) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
    ...
    UploadPage.prototype.uploadFileDevice = function () {
        var _this = this;
        try {
            if (this.platform.is('android')) {
                this.fileChooser.open()
                    ...
                    console.log(_this.TAG, "Selected File", _this.selectedURI);
                    _this.filePath.resolveNativePath(uri).then(function (filePathResult) {
                        console.log(_this.TAG, "Selected fileInfo", filePathResult);
                        _this.fileName = filePathResult.substring(filePathResult.lastIndexOf("/") + 1);
                        var fileType = filePathResult.substring(filePathResult.lastIndexOf(".") + 1);
                        console.log(_this.TAG, "Selected fileInfo File Name", _this.fileName);
                        console.log(_this.TAG, "Selected fileInfo File fileType", fileType);
                        _this.isFile = true;
                    });
                ...
                this.filePicker.pickFile()
                    ...
                    _this.isFile = true;
                    _this.selectedURI = uri;
                    _this.fileName = uri.substring(uri.lastIndexOf("/") + 1);
    ...
    UploadPage.prototype.validate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var files, formData, i, _a, validateData, _b, login, password, auth, save_file_url, fileTransfer, options, error_5;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 8, , 9]);
                        if (!(this.msg.isplatformweb == true)) return [3 /*break*/, 4];
                        this.commonFunction.loadingPresent();
                        files = this.file;
                        if (!(files.name != "")) return [3 /*break*/, 2];
                        ...
                        _a = this;
                        return [4 /*yield*/, this.uploadService.uploadFileService(formData).toPromise()];
                    case 1:
                        _a.formatResponse = _c.sent();
                    ...
                    case 4:
                        ...
                        _b = this;
                        return [4 /*yield*/, this.uploadService.uploadFileServiceAndroidiOS(validateData, this.selectedURI).toPromise()];
                    case 5:
                        _b.formatResponse = _c.sent();
                        if (!!this.formatResponse) {
                            console.log(this.TAG, this.formatResponse);
                            this.commonFunction.loadingDismiss();
                            this.commonFunction.presentAlert("Upload", "Validate", this.formatResponse.msg);
                    ...
                    case 6:
                        if (this.platform.is('ios')) {
                            ...
                            save_file_url = src_app_common_Constants__WEBPACK_IMPORTED_MODULE_15__["Constants"].DOMAIN_URL + '/openbravo' + '/ws/in.mbs.webservice.UploadService?';
                            ...
                            fileTransfer.upload(this.selectedURI, save_file_url, options)
                                ...
                                _this.formatResponse = JSON.parse(data.response);
                                console.log("File Uplaod Result", _this.formatResponse);
                                _this.commonFunction.presentAlert("Upload", "Validate", _this.formatResponse.msg);
    ...
    UploadPage.prototype.process = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var files, processFormData, i, processResponse, validateData, _a, login, password, auth, save_file_url, fileTransfer, options, error_6;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.uploadService.uploadFileService(processFormData).toPromise()];
                    case 1:
                        processResponse = _b.sent();
                        if (!!processResponse) {
                    ...
                    case 6:
                        if (this.platform.is('ios')) {
                            ...
                            fileTransfer.upload(this.selectedURI, save_file_url, options)
                                .then(function (data) {
                                console.log("pravin YESSSSS", data);
                                var reposnse = JSON.parse(data.response);
                                console.log("File Uplaod Result", reposnse);
                                _this.refreshPage();
                                _this.commonFunction.presentAlert("Upload", "Validate", reposnse.msg);
                                _this.commonFunction.loadingDismiss();
                            }, function (err) {
                                console.log("pravin naaaaaaaa", err);
                                _this.commonFunction.loadingDismiss();
    ...
    UploadPage.prototype.format = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
    ...
    UploadPage.prototype.downloadFile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var fileDownloadURL, path, fileTransfer, target;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
                    fileDownloadURL = this.loginService.commonurl + 'ws/in.mbs.webservice.InterfaceDownload?'
                    ...
                    if (this.msg.isplatformweb == false) {
                        ...
                        fileTransfer = this.transfer.create();
                        fileTransfer.download(encodeURI(fileDownloadURL), path + this.selectedMasterName.doc_name).then(function (entry) {
                            console.log('download complete: ' + entry.toURL());
                            _this.fileOpener.open(entry.toURL(), "text/csv")
    ...
    UploadPage.prototype.refreshPage = function () {
        try {
            this.masterNameList = [];
            this.masterSubCategoryList = [];
...
//# sourceMappingURL=upload-upload-upload-module-es5.js.map