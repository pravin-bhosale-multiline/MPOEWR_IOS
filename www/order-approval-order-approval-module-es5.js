...
var OrderApprovalPageModule = /** @class */ (function () {
    function OrderApprovalPageModule() {
    }
    ...
    return OrderApprovalPageModule;
}());
...
var OrderApprovalPage = /** @class */ (function () {
    function OrderApprovalPage(orderApprovalServiceService, commonfun, alertController, storage, loginauth, router, msg, modalController) {
    ...
    OrderApprovalPage.prototype.ngOnInit = function () {
    ...
    OrderApprovalPage.prototype.createURL = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.storage.get('filterStartDate')];
                    case 1:
                        _a.filterStartDate = _c.sent();
                        ...
                        _b = this;
                        return [4 /*yield*/, this.storage.get('filterEndDate')];
                    case 2:
                        _b.filterEndDate = _c.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _c.sent();
                        return [3 /*break*/, 4];
    ...
    OrderApprovalPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.Pageload();
                return [2 /*return*/];
    ...
    OrderApprovalPage.prototype.Pageload = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.orderApprovalServiceService.getOrder(this.getOrderURL)];
                    case 1: return [4 /*yield*/, (_b.sent()).toPromise()];
                    case 2:
                        _a.orderData = _b.sent();
    ...
    OrderApprovalPage.prototype.RefreshPage = function (el) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                el.scrollIntoView();
    ...
    OrderApprovalPage.prototype.saveConfirm = function (id, record, tab_id, status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var message, alert_1, error_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            _this.save(id, record, tab_id, status, "Approve from Ionic");
                                        }
                                    }
                                ]
                            })];
    ...
    OrderApprovalPage.prototype.getDetails = function (id, record, tab_id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, error_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OrderApprovalPage.prototype.rejectConfirm = function (id, record, tab_id, status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var methodTAG, alert_2, error_4;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        methodTAG = 'rejectConfirm';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function (data) {
                                            if (data.txtRemark != null && data.txtRemark.length > 0) {
                                                //  console.log('Confirm Okay');
                                                _this.save(id, record, tab_id, status, data.txtRemark);
                                            }
                                            else {
                                                alert_2.message = '<b style="color: red;">Enter valid remark.</b>';
                                                return false;
                                            }
                                        }
                                    }
    ...
    OrderApprovalPage.prototype.save = function (id, record, tab_id, status, remark) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.commonfun.loadingPresent();
                        return [4 /*yield*/, this.orderApprovalServiceService.saveOrderStatus(id, record, tab_id, status, remark).toPromise()];
                    case 1:
                        response = _a.sent();
                        this.commonfun.loadingDismiss();
                        //  console.log(this.TAG,"Pravin",response);
                        if (response.res == "Success") {
                            this.orderData = this.orderData.filter(function (item) { return item.id !== id; });
                            if ((!!this.orderData && this.orderData.length > 0)) {
                                this.emptyCart = false;
                            }
                            else {
                    ...
                    case 2:
                        ...
                        this.commonfun.loadingDismiss();
                        this.commonfun.presentAlert("Order", "Error", error_5.error);
                        return [3 /*break*/, 3];
    ...
    OrderApprovalPage.prototype.doInfinite = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var tempData, error_6;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    OrderApprovalPage.ctorParameters = function () { return [
...
//# sourceMappingURL=order-approval-order-approval-module-es5.js.map