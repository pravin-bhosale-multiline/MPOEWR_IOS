...
let CustomerServicePage = class CustomerServicePage {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let temp = yield (yield this.customerService.getDocumentList()).toPromise();
            ...
            this.designationOfComplainerList = yield (yield this.customerService.getDesignationOfComplainerList()).toPromise();
    ...
    checkSerialNo() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!!serialNumberTemp) {
                let equipmentData = yield this.customerService.getSerialNumberFromBase(serialNumberTemp).toPromise();
                if (equipmentData) {
    ...
    submit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                let complain = new _assets_model_complain__WEBPACK_IMPORTED_MODULE_1__["Complain"]();
                ...
                let saveComplainResponse = yield this.customerService.saveComplain(complain).toPromise();
...
//# sourceMappingURL=cardinal-customer-service-customer-service-module-es2015.js.map