...
var ProductsearchPage = /** @class */ (function () {
    function ProductsearchPage(loginservc) {
        this.loginservc = loginservc;
    }
    ProductsearchPage.prototype.ngOnInit = function () {
    };
    ProductsearchPage.prototype.onSearchChange = function (ev) {
        // Reset items back to all of the items
        this.filterproductList = this.productlist;
        var val = ev.target.value;
        // if the value is an empty string don't filter the items
        if (val && val.trim() !== '') {
            this.filterproductList = this.filterproductList.filter(function (product) {
                return ((product.mmstMainprodname + product.mmstMainprodcode + product.attributeSetValue)
                    .toLowerCase().indexOf(val.toLowerCase()) > -1);
            });
        }
    };
    ProductsearchPage.ctorParameters = function () { return [
...
//# sourceMappingURL=productsearch-productsearch-module-es5.js.map