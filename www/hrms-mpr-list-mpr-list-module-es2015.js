...
let MprListPage = class MprListPage {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.MPRService.getMPRList().toPromise();
    ...
    detailsClick(mpr) {
        try {
            ...
            let navigationExtras = { queryParams: { special: JSON.stringify(mpr) } };
...
//# sourceMappingURL=hrms-mpr-list-mpr-list-module-es2015.js.map