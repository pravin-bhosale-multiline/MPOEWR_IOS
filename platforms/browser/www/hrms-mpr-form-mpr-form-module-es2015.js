...
let MprFormPage = class MprFormPage {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                this.organizationList = yield this.MPRService.getOrganizationList().toPromise();
                this.qualificationList = yield this.MPRService.getQualificationList().toPromise();
                this.reasonForMPRList = yield this.MPRService.getReasonForMPRList().toPromise();
                this.jobListingList = yield this.MPRService.getJobListingList().toPromise();
                this.resourceRequirementMasterList = yield this.MPRService.getResourceRequirementMasterList().toPromise();
                this.resourceDepartmentMasterList = yield this.MPRService.getResourceDepartmentMasterList().toPromise();
    ...
    onOrganizationChange() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                this.MPRMasterDataList = yield this.MPRService.getMPRMasterDataList(this.selectedOrganization).toPromise();
                ...
                if (!!this.existingMPR) {
                    this.jobTitleList.forEach((job => { if (job.Standardtemp_id == this.existingMPR.Standardtemp_id) {
                        this.selectedJOBTitle = job;
                    } }));
                    this.gradeList.forEach((grade => { if (grade.grade_id == this.existingMPR.grade_id) {
                    ...
                    if (this.AgeRangeModel != undefined && this.AgeRangeModel.upper != undefined && this.AgeRangeModel.upper != 0) {
                        if (!!this.selectedQualificationList && this.selectedQualificationList.length > 0) {
                            if (!!this.jobDescriptionList && this.jobDescriptionList.length > 0) {
                                ...
                                let postMPRForm = yield this.MPRService.postMPRForm(mprPostData).toPromise();
...
//# sourceMappingURL=hrms-mpr-form-mpr-form-module-es2015.js.map