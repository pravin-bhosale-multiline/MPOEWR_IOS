...
var AddeditTravelExpensePageModule = /** @class */ (function () {
    function AddeditTravelExpensePageModule() {
    }
    ...
    return AddeditTravelExpensePageModule;
}());
...
var AddeditTravelExpensePage = /** @class */ (function () {
    function AddeditTravelExpensePage(travelExpenseaddeditFromBuilder, travelExpenseService, commonfun, router, route, alertCtrl, camera, msg) {
    ...
    AddeditTravelExpensePage.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.checkplatform();
        }, 1500);
    };
    AddeditTravelExpensePage.prototype.dateyyyymmddT0000Z = function (dt) {
        try {
    ...
    AddeditTravelExpensePage.prototype.ondatechange = function () {
    ...
    AddeditTravelExpensePage.prototype.checkplatform = function () {
        try {
    ...
    AddeditTravelExpensePage.prototype.getrout = function () {
        var _this = this;
        try {
            this.route.params.subscribe(function (params) {
                if (_this.router.getCurrentNavigation().extras.state) {
                    _this.expenseList = _this.router.getCurrentNavigation().extras.state.expenseList;
                    _this.selectedplan = _this.router.getCurrentNavigation().extras.state.selectedplan;
                    _this.expenseMasterList = _this.router.getCurrentNavigation().extras.state.expenseMasterList;
                    ;
                    var a1 = _this.selectedplan.fromdate.split("-");
                    var dt = new Date(a1[2] + '-' + a1[1] + '-' + a1[0] + 'T00:00Z');
                    _this.travelExpenseFormedit.controls["fromdate"].setValue(dt.toISOString());
                    _this.planfromdate = dt.toISOString();
                    var a2 = _this.selectedplan.todate.split("-");
                    var dt2 = new Date(a2[2] + '-' + a2[1] + '-' + a2[0] + 'T00:00Z');
                    _this.travelExpenseFormedit.controls["todate"].setValue(dt2.toISOString());
                    _this.plantodate = dt2.toISOString();
                    _this.chklength();
                }
            });
        }
    ...
    AddeditTravelExpensePage.prototype.chklength = function () {
        try {
    ...
    AddeditTravelExpensePage.prototype.uploadImage = function (str) {
        var _this = this;
        try {
            ...
            myreader.onloadend = function (e) {
                ...
                _this.Supportingimg64 = b64;
                _this.IsSupportingimg64 = false;
            };
    ...
    AddeditTravelExpensePage.prototype.onChangeAmount = function () {
        try {
    ...
    AddeditTravelExpensePage.prototype.onAdd = function (val) {
        console.log("onAdd");
        var methodTAG = 'onAdd';
        try {
            ...
            if (this.expenseList.length > 0) {
                ...
                var objOne_1 = { "fromdate": this.strfromdate, "todate": this.strtodate, "travelexpense": val.selectableTravelExpenseUIControl.sname };
                try {
                    var checkAlreadyAdded = false;
                    this.expenseList.forEach(function (obj) {
                        var objTwo = { "fromdate": obj.fromdate, "todate": obj.todate, "travelexpense": obj.travelexpense.sname };
                        if (JSON.stringify(objOne_1) === JSON.stringify(objTwo)) {
                            console.log("True");
    ...
    AddeditTravelExpensePage.prototype.getimage = function () {
        var _this = this;
        try {
            var options = {
                quality: 50,
            ...
            this.camera.getPicture(options).then(function (imageData) {
                _this.Supportingimg64 = imageData;
                _this.IsSupportingimg64 = false;
            }, function (err) {
                _this.commonfun.presentAlert("Message", "Error", err);
            });
        }
        catch (error) {
    ...
    AddeditTravelExpensePage.prototype.getSupportingImage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.commonfun.presentAlert("Message", "Error", error_1);
                        return [3 /*break*/, 4];
    ...
    AddeditTravelExpensePage.prototype.takePicture = function () {
        var _this = this;
        try {
            var options = {
                quality: 50,
    ...
    AddeditTravelExpensePage.prototype.ImageViewr = function (img) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                { text: 'Remove',
                                    handler: function (data) {
                                        _this.Supportingimg64 = null;
                                        _this.IsSupportingimg64 = _this.IsSupportingrequired;
                                    }
                                },
                                { text: 'OK' }
                            ],
    ...
    AddeditTravelExpensePage.prototype.Resetpage = function () {
        var methodTAG = 'onChangeExpense';
    ...
    AddeditTravelExpensePage.prototype.removerow = function (post) {
        try {
    ...
    AddeditTravelExpensePage.prototype.onChangeExpense = function () {
        var methodTAG = 'onChangeExpense';
        try {
            //  console.log(methodTAG);
    ...
    AddeditTravelExpensePage.prototype.onAddTravelExpense = function () {
        var methodTAG = 'onSaveTravelExpense';
        try {
    ...
    AddeditTravelExpensePage.ctorParameters = function () { return [
    ...
    return AddeditTravelExpensePage;
}());
...
//# sourceMappingURL=addedit-travel-expense-addedit-travel-expense-module-es5.js.map