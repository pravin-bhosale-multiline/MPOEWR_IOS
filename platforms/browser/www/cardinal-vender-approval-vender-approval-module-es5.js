...
var VenderApprovalPageModule = /** @class */ (function () {
    function VenderApprovalPageModule() {
    }
    ...
    return VenderApprovalPageModule;
}());
...
var VenderApprovalPage = /** @class */ (function () {
    function VenderApprovalPage(venderApprovalService, router) {
        this.venderApprovalService = venderApprovalService;
        this.router = router;
        this.TAG = "VenderApprovalPage";
    }
    VenderApprovalPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, (this.venderApprovalService.getVenderApprovalList()).toPromise()];
                    case 1:
    ...
    VenderApprovalPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    VenderApprovalPage.prototype.refreshPage = function () {
        try {
    ...
    VenderApprovalPage.prototype.detailsClick = function (service) {
        try {
    ...
    VenderApprovalPage.ctorParameters = function () { return [
...
//# sourceMappingURL=cardinal-vender-approval-vender-approval-module-es5.js.map