...
var JoblistPage = /** @class */ (function () {
    function JoblistPage(loginservc, alertController, datePipe, router, loadingController) {
    ...
    JoblistPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.loginservc.getjoblist(this.loginservc.userid).subscribe(function (data) {
            _this.response = data['response'];
            _this.joblist = _this.response['data'];
            _this.totalrow = _this.response.totalRows;
            _this.loadingController.dismiss();
        });
    };
    JoblistPage.prototype.onAccept = function (jobid) {
        var _this = this;
        this.loginservc.acceptJob(jobid).subscribe(function (data) {
            _this.router.navigate(['/job', jobid]);
        });
    };
    JoblistPage.prototype.onReject = function (jobid) {
        var _this = this;
        this.loginservc.rejectJob(jobid).subscribe(function (data) {
            _this.doRefresh(null);
        });
    };
    JoblistPage.prototype.onTransfer = function (jobid) {
        this.router.navigate(['/jobtransfer', jobid]);
    };
    JoblistPage.prototype.doRefresh = function (event) {
        var _this = this;
        this.loginservc.getjoblist(this.loginservc.userid).subscribe(function (data) {
            _this.response = data['response'];
            _this.joblist = _this.response['data'];
    ...
    JoblistPage.ctorParameters = function () { return [
...
//# sourceMappingURL=joblist-joblist-module-es5.js.map