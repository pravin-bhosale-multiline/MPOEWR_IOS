...
var HomePage = /** @class */ (function () {
    function HomePage(loginauth, menuCtrl, platform, storage, msg, loginpage, events, router, commonfun, homeservice, zone, commonFunction) {
        var _this = this;
        ...
        this.events.subscribe('dashbaordEvent', function () {
    ...
    HomePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var twoDefault, noOneDefault, i, i_1;
                ...
                try {
                    ...
                    if (!!this.dashboardTypeList) {
                        ...
                        if (this.dashboardTypeList.length > 1) {
                            noOneDefault = false;
                            for (i = 0; i < this.dashboardTypeList.length; i++) {
                                for (i_1 = 0; i_1 < this.dashboardTypeList.length; i_1++) {
                                    if (this.dashboardTypeList[i_1].default == "N") {
                                        noOneDefault = true;
                                    }
                                    else {
                                        noOneDefault = false;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        if (!(this.targetSalesDashboard == true)) return [3 /*break*/, 3];
                        this.commonFunction.loadingPresent();
                        _a = this;
                        return [4 /*yield*/, this.homeservice.getTargetSalesPeriod().toPromise()];
                    case 2:
                        _a.targetSalesMonthList = _b.sent();
    ...
    HomePage.prototype.chkcust = function () {
        try {
    ...
    HomePage.prototype.getdashboard = function () {
        ...
        try {
            ...
            this.homeservice.getdashboardapi1().subscribe(function (data) {
                var response = data['response'];
                var jsondata = response.data;
                //get month
                _this.homeservice.getdashboardapi(jsondata[0].id).subscribe(function (data2) {
                    var response2 = data2['response'];
                    _this.monthlist = response2.data;
                    _this.selectedaMonth = _this.monthlist[0];
                }, function (error) {
    ...
    HomePage.prototype.onMonthChange = function () {
        var _this = this;
        try {
            // console.log("this.selectedaMonth",this.selectedaMonth);
            this.homeservice.CustomerWiseSalesInfo(this.selectedaMonth.code).subscribe(function (data) {
                var response = data;
                _this.netsales = response.netamt;
                _this.pendingsalesorders = response.pendingordervalue;
    ...
    HomePage.prototype.onDashboardSelectChange = function (selectedDashboard) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, , 9]);
                        if (!(selectedDashboard.code == "HP")) return [3 /*break*/, 1];
                        this.defaultDashboard = true;
                        this.targetSalesDashboard = false;
                        this.netSalesDashboard = false;
                        return [3 /*break*/, 7];
                    case 1:
                        if (!(selectedDashboard.code == "ST")) return [3 /*break*/, 6];
                        this.targetSalesDashboard = true;
                        this.defaultDashboard = false;
                        this.netSalesDashboard = false;
                        _b.label = 2;
    ...
    HomePage.prototype.onTargetSalesMonthChange = function (selectedTargetSalesMonth) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, error_4;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.commonFunction.loadingPresent();
                        _a = this;
                        return [4 /*yield*/, this.homeservice.getTargetSalesPeriodData(selectedTargetSalesMonth).toPromise()];
                    case 1:
                        _a.selectedTargetSalesMonthData = _b.sent();
...
var HomeService = /** @class */ (function () {
    function HomeService(http, loginauth, genericHTTP) {
        this.http = http;
        this.loginauth = loginauth;
        this.genericHTTP = genericHTTP;
        this.TAG = "Dashboard Service";
    }
    HomeService.prototype.getdashboardapi1 = function () {
    ...
    HomeService.prototype.getdashboardapi = function (id) {
    ...
    HomeService.prototype.CustomerWiseSalesInfo = function (date) {
    ...
    HomeService.prototype.getDashboardTypeList = function () {
        try {
            var URL_1 = this.loginauth.commonurl + 'ws/in.mbs.webservice.DashBoardSalesTarget?';
            'userid=' + this.loginauth.userid
                + '&activityid=' + this.loginauth.selectedactivity.id;
            return this.genericHTTP.get(URL_1);
        }
        catch (error) {
            //  console.log(this.TAG,error);
        }
    };
    HomeService.prototype.getTargetSalesPeriod = function () {
        try {
            var URL_2 = this.loginauth.commonurl + 'ws/in.mbs.webservice.DashBoardSalesTarget?'
                + 'userid=' + this.loginauth.userid
                + '&activityid=' + this.loginauth.selectedactivity.id;
            return this.genericHTTP.get(URL_2);
        }
        catch (error) {
            //  console.log(this.TAG,error);
        }
    };
    HomeService.prototype.getTargetSalesPeriodData = function (selectedTargetSalesMonth) {
        try {
            var getTargetSalesPeriodDataURL = this.loginauth.commonurl + 'ws/in.mbs.webservice.DashBoardSalesTarget?'
                + 'userid=' + this.loginauth.userid
                + '&activityid=' + this.loginauth.selectedactivity.id
