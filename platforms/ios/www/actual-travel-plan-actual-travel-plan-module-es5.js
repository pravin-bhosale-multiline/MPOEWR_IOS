...
var ActualTravelPlanPageModule = /** @class */ (function () {
    function ActualTravelPlanPageModule() {
    }
    ...
    return ActualTravelPlanPageModule;
}());
...
var ActualTravelPlanPage = /** @class */ (function () {
    function ActualTravelPlanPage(fb, commonfun, router, route, loginauth, actualtravelplanservice, msg) {
        this.fb = fb;
    ...
    ActualTravelPlanPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    /**
       ...
       * @author Nilesh Patil
       */
    ActualTravelPlanPage.prototype.getsalesperson = function () {
        var _this = this;
        ...
        try {
            ...
            this.actualtravelplanservice.getWMobileUserWisePlanData("N").subscribe(function (data) {
                _this.commonfun.loadingDismiss();
                var response = data;
                _this.salespersoninfo = response;
                _this.formactualtravel.controls["salesperson"].setValue(_this.salespersoninfo[0].salesperson);
                _this.fromdate = _this.salespersoninfo[0].fromdate;
                _this.todate = _this.salespersoninfo[0].todate;
                _this.formactualtravel.controls["homelat"].setValue(_this.salespersoninfo[0].latitude);
                _this.formactualtravel.controls["homelong"].setValue(_this.salespersoninfo[0].longitude);
            }, function (error) {
    ...
    ActualTravelPlanPage.prototype.Dateconversion = function () {
        try {
    ...
    ActualTravelPlanPage.prototype.toggle = function (selectedcartproduct) {
    ...
    ActualTravelPlanPage.prototype.onChangeplan = function () {
        var _this = this;
        this.commonfun.loadingPresent();
        this.actualtravelplanservice.getWMobileUserWisePlanData("N", this.formactualtravel.controls["selectedplan"].value).subscribe(function (data) {
            _this.commonfun.loadingDismiss();
            var result = data;
            ...
            _this.formactualtravel.controls["fromdate"].setValue(_this.dateyyyymmddT0000Z(result[0].fromdate));
            _this.formactualtravel.controls["todate"].setValue(_this.dateyyyymmddT0000Z(result[0].todate));
            if (_this.formactualtravel.controls["fromdate"].value == _this.formactualtravel.controls["todate"].value)
                _this.formactualtravel.controls["traveldate"].setValue(_this.dateyyyymmddT0000Z(result[0].fromdate));
            else
                _this.formactualtravel.controls["traveldate"].setValue(null);
            ...
            var df = _this.formactualtravel.controls["fromdate"].value;
            var dt = _this.formactualtravel.controls["todate"].value;
            _this.traveldatemin = new Date(_this.dateyyyymmddT0000Z(result[0].fromdate)).toISOString();
            _this.traveldatemax = new Date(_this.dateyyyymmddT0000Z(result[0].todate)).toISOString();
            //-----------------------
        });
    };
    ActualTravelPlanPage.prototype.onAddLead = function (item, i) {
        try {
    ...
    ActualTravelPlanPage.prototype.removeLeads = function (post) {
        try {
            var index = this.leads.indexOf(post);
            var result = this.leads.filter(function (item) { return item.line != post.line; });
            this.leads = result;
        }
        catch (error) {
            this.commonfun.presentAlert("Message", "Error", error);
    ...
    //   }
    // }
    ActualTravelPlanPage.prototype.removesubLeads = function (data, subdata) {
        try {
    ...
    ActualTravelPlanPage.prototype.dateyyyymmddT0000Z = function (dt) {
        try {
    ...
    ActualTravelPlanPage.prototype.ondatechange = function () {
        try {
    ...
    ActualTravelPlanPage.prototype.addsublead = function () {
        var _this = this;
        try {
    ...
    ActualTravelPlanPage.prototype.hideshowsublead = function (selectedLead) {
    ...
    ActualTravelPlanPage.prototype.onSaveActualTravelPlan = function (frnvala, issubmit) {
        var _this = this;
        try {
            ...
            var showError_1 = false;
            this.leads.forEach(function (item) {
                item.TaskList.forEach(function (taskItem) {
    ...
    ActualTravelPlanPage.prototype.Resetpage = function () {
        var _this = this;
        try {
    ...
    ActualTravelPlanPage.ctorParameters = function () { return [
...
//# sourceMappingURL=actual-travel-plan-actual-travel-plan-module-es5.js.map