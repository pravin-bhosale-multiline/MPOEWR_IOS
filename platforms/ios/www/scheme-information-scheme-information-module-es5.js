...
var SchemeInformationPageModule = /** @class */ (function () {
    function SchemeInformationPageModule() {
    }
    ...
    return SchemeInformationPageModule;
}());
...
var SchemeInformationPage = /** @class */ (function () {
    function SchemeInformationPage(fb, loginauth, schemeInformationService, commonfun, msg) {
        this.fb = fb;
    ...
    SchemeInformationPage.prototype.ngOnInit = function () {
        this.checkcust();
    };
    SchemeInformationPage.prototype.custsearchChange = function (event) {
        var custsearchtext = event.text; //.replace(/\s/g,'');
        if (custsearchtext.length >= 3) {
            this.bindcustomerapi(custsearchtext);
        }
    };
    SchemeInformationPage.prototype.onCancel = function (event) {
        // console.log("onCancel");
        event.component._searchText = "";
    };
    SchemeInformationPage.prototype.onClose = function (event) {
        // console.log("onClose");
        event.component.searchText = "";
    };
    SchemeInformationPage.prototype.onchangecust = function () {
        try {
    ...
    SchemeInformationPage.prototype.onchangeprod = function () {
        this.selectedddlproduct = this.formscheme.controls["selectedddlproduct"].value;
        this.isgetscheme = false;
    };
    SchemeInformationPage.prototype.checkproduct = function () {
        var _this = this;
        try {
            this.schemeInformationService.getproductapi("", this.selectedBusinessPartner.id).subscribe(function (data) {
                var response = data;
                _this.leastddlproduct = response;
                //==================
                if (_this.leastddlproduct.length == 1) {
                    _this.ddlproduct = _this.leastddlproduct;
                    _this.formscheme.controls["selectedddlproduct"].setValue(_this.ddlproduct[0]);
                    _this.onchangeprod();
                }
                else if (_this.leastddlproduct.length > _this.loginauth.minlistcount) {
                    _this.ddlproduct = null;
                    _this.formscheme.controls["selectedddlproduct"].setValue(null);
                }
                else {
                    _this.ddlproduct = _this.leastddlproduct;
                    _this.formscheme.controls["selectedddlproduct"].setValue(null);
    ...
    SchemeInformationPage.prototype.checkcust = function () {
        var _this = this;
        try {
            this.commonfun.loadingPresent();
            this.schemeInformationService.getcustmerapi("").subscribe(function (data) {
                ...
                if (_this.leastBusinessPartnerlist.length == 1) {
                    ...
                    _this.formscheme.controls["selectedBusinessPartner"].setValue(_this.BusinessPartnerlist[0]);
                    _this.onchangecust();
                }
                else if (_this.leastBusinessPartnerlist.length > _this.loginauth.minlistcount) {
                    _this.BusinessPartnerlist = null;
                    _this.formscheme.controls["selectedBusinessPartner"].setValue(null);
                }
                else {
                    _this.BusinessPartnerlist = _this.leastBusinessPartnerlist;
                    _this.formscheme.controls["selectedBusinessPartner"].setValue(null);
    ...
    SchemeInformationPage.prototype.bindcustomerapi = function (strsearch) {
        var _this = this;
        try {
            if (strsearch != "") {
                this.schemeInformationService.getcustmerapi(strsearch).subscribe(function (data) {
                    var response = data;
    ...
    SchemeInformationPage.prototype.productsearchChange = function (event) {
    ...
    SchemeInformationPage.prototype.bindproduct = function (strsearch) {
        var _this = this;
        try {
            console.log("strsearch", strsearch);
            console.log("this.selectedBusinessPartner.id", this.selectedBusinessPartner.id);
            if (strsearch != "") {
                this.schemeInformationService.getproductapi(strsearch, this.selectedBusinessPartner.id).subscribe(function (data) {
                    var response = data;
    ...
    SchemeInformationPage.prototype.getscheme = function (value) {
        var _this = this;
        try {
            this.schemedata = null;
            this.schemeInformationService.getCustProdWiseScheme(this.selectedBusinessPartner.id, this.selectedddlproduct.id).subscribe(function (data) {
                //const response= data['response'];
                var response = data;
                console.log("Product Schme DATA", data);
                _this.schemedata = data;
                _this.isgetscheme = true;
            }, function (error) {
                //this.commonfun.loadingDismiss();
                _this.commonfun.presentAlert("Message", "Error!", error.statusText + " with status code :" + error.status);
            });
    ...
    SchemeInformationPage.prototype.hideshowdetail = function (i) {
    ...
    SchemeInformationPage.prototype.Resetpage = function () {
    ...
    SchemeInformationPage.ctorParameters = function () { return [
...
var SchemeInformationService = /** @class */ (function () {
    function SchemeInformationService(http, loginauth, genericHTTP, platform) {
        this.http = http;
        this.loginauth = loginauth;
        this.genericHTTP = genericHTTP;
        this.platform = platform;
    }
    SchemeInformationService.prototype.getcustmerapi = function (strsearch) {
    ...
    SchemeInformationService.prototype.getproductapi = function (searchkey, cut_id) {
        return this.genericHTTP.get(this.loginauth.commonurl + 'ws/in.mbs.webservice.CustWiseProductScheme?'
            + 'searchchar=' + searchkey
            + '&cut_id=' + cut_id);
    };
    SchemeInformationService.prototype.getCustProdWiseScheme = function (cut_id, prod_id) {
    ...
    SchemeInformationService.ctorParameters = function () { return [
    ...
    return SchemeInformationService;
}());
...
//# sourceMappingURL=scheme-information-scheme-information-module-es5.js.map