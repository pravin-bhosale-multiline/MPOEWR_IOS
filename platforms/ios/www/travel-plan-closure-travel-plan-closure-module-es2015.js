...
let TravelPlanClosureService = class TravelPlanClosureService {
    ...
    getPlan(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                return yield this.http.get('assets/data/planMaster.json');
            }
            catch (error) {
            }
        });
    ...
    getExpenseMasterList() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                return yield this.http.get('assets/data/expenseMasterList.json');
            }
            catch (error) {
            }
        });
...
//# sourceMappingURL=travel-plan-closure-travel-plan-closure-module-es2015.js.map