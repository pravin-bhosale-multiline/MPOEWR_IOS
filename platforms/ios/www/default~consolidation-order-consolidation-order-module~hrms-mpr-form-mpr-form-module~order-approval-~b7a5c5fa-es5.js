...
var ApprovalModalService = /** @class */ (function () {
    function ApprovalModalService(genericHTTP, loginauth, http) {
        this.genericHTTP = genericHTTP;
        this.loginauth = loginauth;
        this.http = http;
        this.TAG = "ApprovalModalService";
    }
    ApprovalModalService.prototype.getApprovalDetails = function (id, record, tab_id) {
        try {
            var url = src_app_common_Constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].DOMAIN_URL + "/openbravo/ws/in.mbs.webservice.approval-details?"
    ...
    ApprovalModalService.ctorParameters = function () { return [
...
var ShowApprovalDetailsModalPage = /** @class */ (function () {
    function ShowApprovalDetailsModalPage(modalController, navParams, approvalModalService, screenOrientation, msg, commonfun) {
    ...
    ShowApprovalDetailsModalPage.prototype.ngOnInit = function () {
        this.setPage({ offset: 0 });
        // set to landscape
    };
    ShowApprovalDetailsModalPage.prototype.ionViewWillEnter = function () {
        if (this.msg.isplatformweb == false) {
            this.screenOrientation.lock(this.screenOrientation.ORIENTATIONS.LANDSCAPE);
        }
    };
    ShowApprovalDetailsModalPage.prototype.closeModal = function () {
    ...
    ShowApprovalDetailsModalPage.prototype.setPage = function (pageInfo) {
        var _this = this;
        this.commonfun.loadingPresent();
        this.approvalModalService.getApprovalDetails(this.id, this.record, this.tab_id).subscribe(function (pagedData) {
            // console.log("Pravin Modal DATA ",pagedData);
            if (!!pagedData.data && !!pagedData.data.colum_names) {
                _this.column_data = pagedData.data.colum_names;
                _this.rows = pagedData.data.colum_data;
            }
            else {
    ...
    ShowApprovalDetailsModalPage.ctorParameters = function () { return [
    ...
    return ShowApprovalDetailsModalPage;
}());
...
//# sourceMappingURL=default~consolidation-order-consolidation-order-module~hrms-mpr-form-mpr-form-module~order-approval-~b7a5c5fa-es5.js.map