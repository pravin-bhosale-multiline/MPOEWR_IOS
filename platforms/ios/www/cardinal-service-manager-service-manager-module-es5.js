...
var ServiceManagerPageModule = /** @class */ (function () {
    function ServiceManagerPageModule() {
    }
    ...
    return ServiceManagerPageModule;
}());
...
var ServiceManagerPage = /** @class */ (function () {
    function ServiceManagerPage(serviceManagerService, router, commonFunction) {
    ...
    ServiceManagerPage.prototype.ngOnInit = function () {
        console.log(this.TAG, "ngOnInit Fired");
    };
    ServiceManagerPage.prototype.ionViewWillEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        _a = this;
                        return [4 /*yield*/, this.serviceManagerService.getComplaintList()];
                    case 2: return [4 /*yield*/, (_b.sent()).toPromise()];
                    case 3:
                        _a.complaintList = _b.sent();
                        console.log(this.TAG, this.complaintList);
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _b.sent();
                        this.commonFunction.presentAlert("Compliant Report", "Error", error_1.error);
                        console.error(this.TAG, error_1);
                        return [3 /*break*/, 5];
    ...
    ServiceManagerPage.prototype.refreshPage = function () {
        try {
    ...
    ServiceManagerPage.prototype.detailsClick = function (complaint) {
        try {
    ...
    ServiceManagerPage.ctorParameters = function () { return [
...
//# sourceMappingURL=cardinal-service-manager-service-manager-module-es5.js.map