...
var HideHeaderDirective = /** @class */ (function () {
    ...
    HideHeaderDirective.ctorParameters = function () { return [
...
var SortPage = /** @class */ (function () {
    function SortPage(alertController, storage, router, approvalModalService, screenOrientation, elementRef) {
    ...
    SortPage.prototype.ngOnInit = function () {
    ...
    SortPage.prototype.clearFilter = function () {
    ...
    SortPage.prototype.menuItemClick = function (index) {
        try {
        }
        catch (error) {
    ...
    SortPage.prototype.applyFilter = function () {
    ...
    SortPage.prototype.setPage = function (pageInfo) {
        var _this = this;
        this.page.pageNumber = pageInfo.offset;
        this.approvalModalService.getApprovalDetails("1", "186", "12").subscribe(function (data) {
            console.log("Pravin Modal DATA ", data);
            _this.column_data = data.colum_names;
            _this.rows = data.colum_data;
        });
    };
    SortPage.prototype.getdata = function () {
        var _this = this;
        this.approvalModalService.getApprovalDetails("1", "186", "12").subscribe(function (data) {
            console.log("Pravin Modal DATA ", data);
            _this.column_data = data.data.colum_names;
            _this.rows = data.data.colum_data;
        });
    };
    SortPage.prototype.adjustColumnMinWidth = function () {
        var element = this.elementRef.nativeElement;
        var rows = element.getElementsByTagName("datatable-body-row");
        for (var i = 0; i < rows.length; i++) {
            var cells = rows[i].getElementsByTagName("datatable-body-cell");
            for (var k = 0; k < cells.length; k++) {
                var cell = cells[k];
                var cellSizer = cell.children[0].children[0];
                var sizerWidth = cellSizer.getBoundingClientRect().width;
    ...
    SortPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sort-sort-module-es5.js.map